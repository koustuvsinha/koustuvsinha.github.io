...
In my [[/en/post/emacs_research_workflow/][last blog post]] I described a method I use to keep track of my paper reading habits, using Emacs. Using the workflow, I can now:
...
We are in luck! In my [[/en/post/emacs_research_workflow/][last blog post]], I wrote functions to do 2-4! Re-using the function again here:
